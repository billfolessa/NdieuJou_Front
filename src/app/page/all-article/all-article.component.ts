     ...
     "$1300/mon","1808 Bolingbroke Pl, Fort Worth, TX 76140",2,"40 Sq. Ft.","2022-09-22T15:00:00")
      ...
      filterProcess(){
        if(this.listPropertyInternal != null && this.listPropertyInternal != undefined){
          if(this.sortOption.find(e=>e=="sortAsceding") == "sortAsceding"){
      ...
      filterLocalisation(arraySortOption:string[], propertyToFilter:Property[]):Property[]{
        let result:Property[] = []
        if(propertyToFilter != null && propertyToFilter != undefined && arraySortOption != null && arraySortOption != undefined){
          result = propertyToFilter.filter(item => {
